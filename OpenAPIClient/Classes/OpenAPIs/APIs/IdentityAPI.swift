...
open class IdentityAPI {
     ...
     */
    @discardableResult
    open class func createRecoveryLinkForIdentity(createRecoveryLinkForIdentityBody: CreateRecoveryLinkForIdentityBody? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: RecoveryLinkForIdentity?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func listIdentitySchemas(perPage: Int64? = nil, page: Int64? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [IdentitySchemaContainer]?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func listIdentitySessions(id: String, perPage: Int64? = nil, page: Int64? = nil, active: Bool? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: [Session]?, _ error: Error?) -> Void)) -> RequestTask {
