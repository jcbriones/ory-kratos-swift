...
public struct OryIdentity: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var credentials: [String: OryIdentityCredentials]?
    ...
    public init(createdAt: Date? = nil, credentials: [String: OryIdentityCredentials]? = nil, id: String, metadataAdmin: JSONValue? = nil, metadataPublic: JSONValue? = nil, organizationId: String? = nil, recoveryAddresses: [OryRecoveryIdentityAddress]? = nil, schemaId: String, schemaUrl: String, state: OryState? = nil, stateChangedAt: Date? = nil, traits: JSONValue?, updatedAt: Date? = nil, verifiableAddresses: [OryVerifiableIdentityAddress]? = nil) {
...
extension OryIdentity: Identifiable {}
