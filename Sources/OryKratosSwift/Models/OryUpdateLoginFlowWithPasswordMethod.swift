//
// OryUpdateLoginFlowWithPasswordMethod.swift
//
...
public struct OryUpdateLoginFlowWithPasswordMethod: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(csrfToken: String? = nil, identifier: String, method: String, password: String, passwordIdentifier: String? = nil, transientPayload: JSONValue? = nil) {
