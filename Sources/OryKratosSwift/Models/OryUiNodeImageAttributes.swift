//
// OryUiNodeImageAttributes.swift
//
...
public struct OryUiNodeImageAttributes: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(height: Int64, id: String, nodeType: OryNodeType, src: String, width: Int64) {
        self.height = height
        self.id = id
...
extension OryUiNodeImageAttributes: Identifiable {}
