//
// OryUpdateSettingsFlowWithWebAuthnMethod.swift
//
...
public struct OryUpdateSettingsFlowWithWebAuthnMethod: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(csrfToken: String? = nil, method: String, transientPayload: JSONValue? = nil, webauthnRegister: String? = nil, webauthnRegisterDisplayname: String? = nil, webauthnRemove: String? = nil) {
