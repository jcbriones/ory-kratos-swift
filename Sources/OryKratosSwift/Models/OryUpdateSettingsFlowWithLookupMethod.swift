//
// OryUpdateSettingsFlowWithLookupMethod.swift
//
...
public struct OryUpdateSettingsFlowWithLookupMethod: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(csrfToken: String? = nil, lookupSecretConfirm: Bool? = nil, lookupSecretDisable: Bool? = nil, lookupSecretRegenerate: Bool? = nil, lookupSecretReveal: Bool? = nil, method: String, transientPayload: JSONValue? = nil) {
