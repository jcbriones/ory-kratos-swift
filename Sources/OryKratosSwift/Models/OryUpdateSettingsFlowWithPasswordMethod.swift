//
// OryUpdateSettingsFlowWithPasswordMethod.swift
//
...
public struct OryUpdateSettingsFlowWithPasswordMethod: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(csrfToken: String? = nil, method: String, password: String, transientPayload: JSONValue? = nil) {
