...
public struct OryLoginFlow: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var requestedAal: OryAuthenticatorAssuranceLevel?
    ...
    public init(active: OryActive? = nil, createdAt: Date? = nil, expiresAt: Date, id: String, issuedAt: Date, oauth2LoginChallenge: String? = nil, oauth2LoginRequest: OryOAuth2LoginRequest? = nil, organizationId: String? = nil, refresh: Bool? = nil, requestUrl: String, requestedAal: OryAuthenticatorAssuranceLevel? = nil, returnTo: String? = nil, sessionTokenExchangeCode: String? = nil, state: JSONValue?, transientPayload: JSONValue? = nil, type: String, ui: OryUiContainer, updatedAt: Date? = nil) {
        self.active = active
...
extension OryLoginFlow: Identifiable {}
