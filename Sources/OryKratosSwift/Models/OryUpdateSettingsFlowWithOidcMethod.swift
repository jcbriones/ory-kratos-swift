//
// OryUpdateSettingsFlowWithOidcMethod.swift
//
...
public struct OryUpdateSettingsFlowWithOidcMethod: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(flow: String? = nil, link: String? = nil, method: String, traits: JSONValue? = nil, transientPayload: JSONValue? = nil, unlink: String? = nil, upstreamParameters: JSONValue? = nil) {
        self.flow = flow
        self.link = link
        self.method = method
        self.traits = traits
