//
// OryUpdateVerificationFlowWithLinkMethod.swift
//
...
public struct OryUpdateVerificationFlowWithLinkMethod: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(csrfToken: String? = nil, email: String, method: OryMethod, transientPayload: JSONValue? = nil) {
