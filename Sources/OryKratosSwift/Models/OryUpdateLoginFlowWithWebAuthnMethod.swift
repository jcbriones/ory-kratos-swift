//
// OryUpdateLoginFlowWithWebAuthnMethod.swift
//
...
public struct OryUpdateLoginFlowWithWebAuthnMethod: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(csrfToken: String? = nil, identifier: String, method: String, transientPayload: JSONValue? = nil, webauthnLogin: String? = nil) {
