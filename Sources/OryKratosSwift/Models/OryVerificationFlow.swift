...
public struct OryVerificationFlow: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(active: String? = nil, expiresAt: Date? = nil, id: String, issuedAt: Date? = nil, requestUrl: String? = nil, returnTo: String? = nil, state: JSONValue?, transientPayload: JSONValue? = nil, type: String, ui: OryUiContainer) {
        self.active = active
...
extension OryVerificationFlow: Identifiable {}
