//
// OrySelfServiceFlowExpiredError.swift
//
...
public struct OrySelfServiceFlowExpiredError: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(error: OryGenericError? = nil, expiredAt: Date? = nil, since: Int64? = nil, useFlowId: String? = nil) {
        self.error = error
