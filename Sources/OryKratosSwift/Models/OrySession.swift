...
/** A Session */
public struct OrySession: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var authenticationMethods: [OrySessionAuthenticationMethod]?
    public var authenticatorAssuranceLevel: OryAuthenticatorAssuranceLevel?
    /** Devices has history of all endpoints where the session was used */
    public var devices: [OrySessionDevice]?
    ...
    public init(active: Bool? = nil, authenticatedAt: Date? = nil, authenticationMethods: [OrySessionAuthenticationMethod]? = nil, authenticatorAssuranceLevel: OryAuthenticatorAssuranceLevel? = nil, devices: [OrySessionDevice]? = nil, expiresAt: Date? = nil, id: String, identity: OryIdentity? = nil, issuedAt: Date? = nil, tokenized: String? = nil) {
        self.active = active
...
extension OrySession: Identifiable {}
