//
// OryUiNodeScriptAttributes.swift
//
...
public struct OryUiNodeScriptAttributes: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(async: Bool, crossorigin: String, id: String, integrity: String, nodeType: OryNodeType, nonce: String, referrerpolicy: String, src: String, type: String) {
        self.async = async
...
extension OryUiNodeScriptAttributes: Identifiable {}
