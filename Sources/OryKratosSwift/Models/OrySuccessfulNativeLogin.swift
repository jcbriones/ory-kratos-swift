//
// OrySuccessfulNativeLogin.swift
//
...
public struct OrySuccessfulNativeLogin: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public init(continueWith: [OryContinueWith]? = nil, session: OrySession, sessionToken: String? = nil) {
